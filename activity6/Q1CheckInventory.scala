object Q1CheckInventory {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(
      "All product names in inventory1: " + retrieveAllProductNames(inventory1)
    )

    println(
      "Total value of all products in inventory1: " + calculateTotalValue(
        inventory1
      )
    )
